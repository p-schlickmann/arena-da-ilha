...
class PlayerView(BaseView):
    ...
    def open(self, available_days, balance):
        # buttons = [
        ...
        div = [
            ...
            [sg.Text(f'{balance} créditos', font=('Helvetica', 15), text_color='black', )],
        ]
    ...
    def open_select_courts(self, selected_day, selected_time, courts, total_value):
        div = [
            [sg.Text('Olá, Jogador', font=('Helvetica', 15), text_color='black', )],
            ...
            [sg.Text(f'Valor final: {total_value} créditos', font=('Helvetica', 15),
                     text_color='black', )],
